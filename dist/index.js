import path, { parse, resolve, normalize, join } from 'path';
import fs$1, { existsSync, statSync, mkdirSync } from 'fs';
...
const writeFileAsync = promisify(fs$1.writeFile);
promisify(fs$1.readFile);
